...
CREATE TABLE `oms_order`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT 'Submit Time',
  `member_username` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'User Account',
  `total_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Order Total Amount',
  `pay_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Actual Payment Amount',
  `freight_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Shipping Amount',
  `promotion_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Promotional optimization amount (promotional price, full discount, tiered price)',
  ...
  `discount_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Administrator background adjusts the discount amount used by the order',
  `pay_type` int(1) NULL DEFAULT NULL COMMENT 'Payment Methods：0->Unpaid；1->Card；2->Paypal',
  `source_type` int(1) NULL DEFAULT NULL COMMENT 'Order Source：0->PC；1->App',
  `status` int(1) NULL DEFAULT NULL COMMENT 'Order Status：0->Pending Payment；1->Pending Shipment；2->Shipped；3->Completed；4->Closed；5->Invalid Order',
  `order_type` int(1) NULL DEFAULT NULL COMMENT 'Order Type：0->Normal Order；1->Flash Sale',
  ...
  `delivery_sn` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Logistics number',
  `auto_confirm_day` int(11) NULL DEFAULT NULL COMMENT 'Automatic confirmation time (days)',
  `integration` int(11) NULL DEFAULT NULL COMMENT 'Obtainable points',
  `growth` int(11) NULL DEFAULT NULL COMMENT 'Available growth value',
  ...
  `bill_receiver_phone` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Invoice recipient phone',
  `bill_receiver_email` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Invoice recipient email',
  `receiver_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'Recipient name',
  `receiver_phone` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'Recipient phone',
  `receiver_post_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Recipient zipcode',
  `receiver_province` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'State',
  ...
  `receiver_detail_address` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Address',
  ...
  `delete_status` int(1) NOT NULL DEFAULT 0 COMMENT 'Deletion status: 0->Not deleted; 1->Deleted',
  `use_integration` int(11) NULL DEFAULT NULL COMMENT 'Integration used when placing the order',
  ...
  `receive_time` datetime NULL DEFAULT NULL COMMENT 'Confirmation received time',
  `comment_time` datetime NULL DEFAULT NULL COMMENT 'Comment time',
